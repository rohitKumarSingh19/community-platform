...
const LearnGrowPage = () => {
  ...
  useEffect(() => {
    axios.get('https://community-platform-4.onrender.com/api/discussions')
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.post('https://community-platform-4.onrender.com/api/discussions/create', { title, content }, {
