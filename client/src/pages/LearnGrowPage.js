...
const LearnGrowPage = () => {
  ...
  useEffect(() => {
    axios.get('https://community-platform-backend-ibib.onrender.com/api/discussions')
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.post('https://community-platform-backend-ibib.onrender.com/api/discussions/create', { title, content }, {
